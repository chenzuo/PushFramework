...
public:
    ...
    PhysicalConnection(ServerImpl* pServerImpl);
    ~PhysicalConnection();

	void reset(SOCKET s, SOCKADDR_IN address, ListenerOptions* pListenerOptions);
...
public:
    ...
    void postReceive();
    bool readReceivedBytes(Buffer& incomingBytes, int dwIoSize);

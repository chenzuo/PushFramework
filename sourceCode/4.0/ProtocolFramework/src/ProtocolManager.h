...
namespace ProtocolFramework
{
	...
	{
	public:
        ProtocolManager(MemoryAllocator* pAllocator);
        ...
        NetworkSerializeResult::Type serializeOutgoingBytes(Connection& connection, Buffer& outgoingBytes, Buffer& outputBuffer, SerializeData& serializeData);

...
namespace ProtocolFramework
{
	...
	public:	
		...
		bool initialize(unsigned int nMaxContexts, MemoryAllocator* pAllocator);
	
		//
		virtual ProtocolContext* createNewProtocolContext() = 0;
	...
	public:
        ...
        MemoryAllocator& getMsgBufferPool();

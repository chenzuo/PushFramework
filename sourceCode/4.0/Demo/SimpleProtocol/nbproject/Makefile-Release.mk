...
${OBJECTDIR}/src/SimpleProtocol.o: src/SimpleProtocol.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ProtocolFramework/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SimpleProtocol.o src/SimpleProtocol.cpp

${OBJECTDIR}/src/stdafx.o: src/stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../ProtocolFramework/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/stdafx.o src/stdafx.cpp

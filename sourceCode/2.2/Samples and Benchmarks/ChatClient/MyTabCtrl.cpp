...
{
    m_tabPages[0]=new CConsoleTab;
    m_tabPages[1]=new CDirectChatTab;
    m_tabPages[2]=new CRoomChatTab;
...
void CMyTabCtrl::Init()
{
    ...
    m_tabPages[0]->Create(IDD_CONSOLETAB, this);
    m_tabPages[1]->Create(IDD_DIRECTCHATTAB, this);
    m_tabPages[2]->Create(IDD_ROOMCHATTAB, this);

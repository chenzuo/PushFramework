...
${OBJECTDIR}/src/LeaveRoomRequestService.o: src/LeaveRoomRequestService.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/LeaveRoomRequestService.o src/LeaveRoomRequestService.cpp

${OBJECTDIR}/src/RoomChatRequestService.o: src/RoomChatRequestService.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/RoomChatRequestService.o src/RoomChatRequestService.cpp

${OBJECTDIR}/src/LogoutRequestService.o: src/LogoutRequestService.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/LogoutRequestService.o src/LogoutRequestService.cpp

${OBJECTDIR}/src/DirectChatRequestService.o: src/DirectChatRequestService.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/DirectChatRequestService.o src/DirectChatRequestService.cpp

${OBJECTDIR}/src/ChatServer.o: src/ChatServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ChatServer.o src/ChatServer.cpp

${OBJECTDIR}/src/ChatParticipant.o: src/ChatParticipant.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ChatParticipant.o src/ChatParticipant.cpp

${OBJECTDIR}/src/JoinRoomRequestService.o: src/JoinRoomRequestService.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/JoinRoomRequestService.o src/JoinRoomRequestService.cpp
...
${OBJECTDIR}/src/ChatParticipantFactory.o: src/ChatParticipantFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ChatParticipantFactory.o src/ChatParticipantFactory.cpp
